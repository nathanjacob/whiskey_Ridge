...
*/
//The following line goes in anything you want to be a fast travel node
...
_distTimeMultip = 1; //(time = distance * _distTimeMultip)
_Citys = ["kindufAirfield","apache","f15","a10","f16"];	//These have to be markers!!! - Marker names will be displayed as the name of the location
