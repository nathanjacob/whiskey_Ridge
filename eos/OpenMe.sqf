...
while {(getmarkerColor _checkString) != ""} do {
	_builtArray pushback _checkString;
	//(_checkString) setMarkerAlpha 0;
...
[4],
[0,0],
[5,1,1000,EAST,TRUE,FALSE]] call EOS_Spawn;

//Spawn Civilian stuff (Custom civ classes)
null =[_builtArray,
[4,4],
[4,0],
[3,1],
...
[0],
[0,0],
[7,1,1000,CIVILIAN,TRUE,FALSE]] call EOS_Spawn;
